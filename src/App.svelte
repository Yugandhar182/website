...
<main>
  ...
  <div class="information">
    <a on:click={openWhyRecruitlyPopup} class="why-recruitly-anchor" style="color: blue; font-weight: 700;">Why Recruitly</a>
     ...
     <a href="src_RecruitingAutomation.svelte" style="color: blue; font-weight: 700; cursor: pointer;">Automation</a>
    <a href="src_RecruitingPricing.svelte" style="color: blue; font-weight: 700; cursor: pointer;">Pricing</a>
